...
void Bureaucrat::executeForm(const Form &form) const
{
	if (this->_grade > form.getGradeSign())
	{
		std::cout << "Bureaucrat " << this->_name << " no executes " << form.getName() << " form, because Grade Too Low" << std::endl;
	}
	else if (!form.isSigned())
	{
		std::cout << "Bureaucrat " << this->_name << " no executes " << form.getName() << " form, because Unsigned." << std::endl;
	}
	else
	{
		std::cout << "Bureaucrat " << this->_name << " executes " << form.getName() << " form." << std::endl;
	}
}
